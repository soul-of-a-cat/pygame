...
import pygame
import math
from player import shooter, bullets, all_sprites, player_group, width, height, clock, FPS, player_damage
from player import player_life, player_repair, tiles_group, level_x, tile_width, new_level, screen
